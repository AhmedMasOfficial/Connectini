            ...
            <div class="grid  md:grid-cols-2 ">
                <div>
                    <div class="h-52 w-52 object-center overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-auto">
                        <img src="st.png" loading="lazy" alt="Photo by Martin Sanchez" class="h-full w-full object-cover object-center" />
                      </div>
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-[110px] rounded-lg sm:rounded-none sm:rounded-l-lg" src="sos1.webp" alt="Bonnie Avatar">
                    </a>
                    <div class="p-5">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-[110px] rounded-lg sm:rounded-none sm:rounded-l-lg" src="sos2.png" alt="Jese Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">TECH</a>
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-[110px] rounded-lg sm:rounded-none sm:rounded-l-lg" src="sos3.jpg" alt="Michael Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="w-[110px] rounded-lg sm:rounded-none sm:rounded-l-lg" src="sos4.webp" alt="Sofia Avatar">
                    </a>
                    <div class="p-5">
                        <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Tech Savy</a>
...
if($result->num_rows>0){
    while($ligne=$result->fetch_array()){
        ...
        echo "<tbody><tr class='bg-white border-b dark:bg-gray-800 dark:border-gray-700'><th scope='row' class='px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white'>$nom</th><td class='px-6 py-4'>$mail</td><td class='px-6 py-4'>$capacite</td><td class='px-6 py-4 text-right'><a href='#' class='font-medium text-green-600 dark:text-green-500 hover:underline'>Envoyer une invitation</a></td></tr>";
                }
    }
?>
